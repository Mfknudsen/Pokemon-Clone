...
public class EditorPokemon : Editor
{
    Pokemon script = null;
    Color standard = new Color(0.2f, 0.2f, 0.2f), statsColor = new Color(0.973f, 0.816f, 0.188f, 1);
    GUIStyle headerStyle, subheaderStyle, textStyle;
    bool showLearnset = false;
    ...
    private void ShowMoves()
    {
        ...
        if (showLearnset)
        {
            ...
            List<Pokemon> resultValuePoke = new List<Pokemon>();
            resultValue = new List<PokemonMove>();
