...
namespace Mfknudsen.Common.CommonPath
{
        ...
        private void Draw()
        {
            ...
            for (int i = 0; i < Path.NumPoints; i++)
            {
                if (i % 3 == 0 || creator.displayControlPoints)
                {
                    ...
                    Vector3 newPos = Handles.FreeMoveHandle(Path[i], Quaternion.identity, handleSize, Vector3.zero,
